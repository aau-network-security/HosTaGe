...
import dk.aau.netsec.hostage.logging.SyncDeviceDao;
import dk.aau.netsec.hostage.persistence.DAO.SyncDeviceDAO;
...
public class SyncDeviceDAOTest {
    ...
    public void  testUpdateSyncDevices(){
        String deviceId = "dk/aau/netsec/hostage/fragment";
