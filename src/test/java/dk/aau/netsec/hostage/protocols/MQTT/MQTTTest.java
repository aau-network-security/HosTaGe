package dk.aau.netsec.hostage.protocols.MQTT;
...
public class MQTTTest {
    ...
    public void testMoquette() throws Exception{
        ...
        assertEquals("SUCCESS",client.connect().getReturnCode().name());
        client.publishWith().topic(topic).qos(MqttQos.AT_LEAST_ONCE).payload("dk/aau/netsec/hostage/fragment".getBytes()).send();
