    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (this.isMultipleChoice) {
            builder.setTitle(title).setMultiChoiceItems(titles, selectedArray,
                    ...
                    }).setPositiveButton(R.string.button_title_apply, (dialog, id) -> mListener.onDialogPositiveClick(ChecklistDialog.this))
                    .setNegativeButton(R.string.button_title_cancel, (dialog, id) -> mListener.onDialogNegativeClick(ChecklistDialog.this));
