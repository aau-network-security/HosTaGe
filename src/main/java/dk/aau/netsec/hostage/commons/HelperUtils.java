...
public final class HelperUtils {
    ...
    public static boolean isFileInjected() {
        return isFileInjected;
    }

    public static void setIsFileInjected(boolean isFileInjected) {
        HelperUtils.isFileInjected = isFileInjected;
    }
     ...
     * @param forceLength forces the String to be exact the given length instead of
     *                    maximum
