...
public class SubnetUtils {
     ...
     * This also applies to {@link SubnetUtils.SubnetInfo#()}
    ...
    public final class SubnetInfo {
         ...
         * network and broadcast addresses. Use {@link SubnetUtils()}
         * to change this.
         ...
         * Returns true if the parameter <code>address</code> is in the
         * range of usable endpoint addresses for this subnet. This excludes the
         * network and broadcast addresses by default. Use {@link SubnetUtils()}
         * to change this.
