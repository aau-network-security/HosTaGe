...
public class HostageDBOpenHelper extends SQLiteOpenHelper {
    ...
    static {
        ...
        String networkSQLBuilder = "CREATE TABLE " + HostageDBContract.NetworkEntry.TABLE_NAME + "(" +
                ...
                HostageDBContract.NetworkEntry.COLUMN_NAME_LONGITUDE + " INTEGER," +
        ...
        String attackSQLBuilder = "CREATE TABLE " + HostageDBContract.AttackEntry.TABLE_NAME + "(" +
                ...
                HostageDBContract.AttackEntry.COLUMN_NAME_LOCAL_IP + " BLOB," +
                HostageDBContract.AttackEntry.COLUMN_NAME_LOCAL_PORT + " INTEGER," +
                HostageDBContract.AttackEntry.COLUMN_NAME_REMOTE_IP + " BLOB," +
                HostageDBContract.AttackEntry.COLUMN_NAME_REMOTE_PORT + " INTEGER," +
                HostageDBContract.AttackEntry.COLUMN_NAME_INTERNAL_ATTACK + " INTEGER," +
                HostageDBContract.AttackEntry.COLUMN_NAME_BSSID + " TEXT," +
                HostageDBContract.AttackEntry.COLUMN_NAME_SYNC_ID + " INTEGER," +
                HostageDBContract.AttackEntry.COLUMN_NAME_DEVICE + " TEXT," +
                String.format("FOREIGN KEY(%s) REFERENCES %s(%s) ON DELETE CASCADE ON UPDATE CASCADE,", HostageDBContract.AttackEntry.COLUMN_NAME_BSSID, HostageDBContract.NetworkEntry.TABLE_NAME,
        ...
        String packetSQLBuilder = "CREATE TABLE " + HostageDBContract.PacketEntry.TABLE_NAME + "(" +
                ...
                HostageDBContract.PacketEntry.COLUMN_NAME_PACKET_TIMESTAMP + " INTEGER," +
                HostageDBContract.PacketEntry.COLUMN_NAME_PACKET + " TEXT," +
                String.format("PRIMARY KEY(%s,%s)", HostageDBContract.PacketEntry.COLUMN_NAME_ID, HostageDBContract.PacketEntry.COLUMN_NAME_ATTACK_ID) +
        ...
        String syncInfoSQLBuilder = "CREATE TABLE " + HostageDBContract.SyncInfoEntry.TABLE_NAME + "(" +
                ...
                HostageDBContract.SyncInfoEntry.COLUMN_NAME_NUMBER_PORTSCANS + " INTEGER," +
                String.format("PRIMARY KEY(%s,%s)", HostageDBContract.SyncInfoEntry.COLUMN_NAME_DEVICE_ID, HostageDBContract.SyncInfoEntry.COLUMN_NAME_BSSID) +
        ...
        String profilSQLBuilder = "CREATE TABLE " + HostageDBContract.ProfileEntry.TABLE_NAME + "(" +
                ...
                HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_ICON + " TEXT," +
                HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_ICON_NAME + " TEXT," +
    ...
    synchronized public void updateSyncDevicesMaxID(SQLiteDatabase db) {
        HashMap<String, Long> deviceIDmap = new HashMap<>();
    ...
    public synchronized ArrayList<NetworkRecord> getMissingNetworkRecords(ArrayList<String> otherBSSIDs) {
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);
        ArrayList<NetworkRecord> networkInformation = new ArrayList<>();
        // looping through all rows and adding to list
        if (cursor.moveToFirst()) {
            do {
    ...
    public synchronized ArrayList<AttackRecord> getRecordOfEachAttack() {
        ArrayList<AttackRecord> recordList = new ArrayList<>();
    ...
    public synchronized ArrayList<SyncInfoRecord> getSyncInfo() {
        SQLiteDatabase db = this.getReadableDatabase();
        ArrayList<SyncInfoRecord> syncInfo = new ArrayList<>();
    ...
    public ArrayList<MessageRecord> getMessageRecords(AttackRecord attackRecord, SQLiteDatabase db) {
        ArrayList<MessageRecord> mr = new ArrayList<>();
