...
public class HostageDBOpenHelper extends SQLiteOpenHelper {
	...
	static {
        // NETWORK
		StringBuilder networkSQLBuilder = new StringBuilder("CREATE TABLE ").append(HostageDBContract.NetworkEntry.TABLE_NAME).append("(");
		networkSQLBuilder.append(HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID).append(" TEXT PRIMARY KEY,");
		networkSQLBuilder.append(HostageDBContract.NetworkEntry.COLUMN_NAME_SSID).append(" TEXT,");
		networkSQLBuilder.append(HostageDBContract.NetworkEntry.COLUMN_NAME_LATITUDE).append(" INTEGER,");
		networkSQLBuilder.append(HostageDBContract.NetworkEntry.COLUMN_NAME_LONGITUDE).append(" INTEGER,");
		networkSQLBuilder.append(HostageDBContract.NetworkEntry.COLUMN_NAME_ACCURACY).append(" INTEGER,");
		networkSQLBuilder.append(HostageDBContract.NetworkEntry.COLUMN_NAME_GEO_TIMESTAMP).append(" INTEGER");
		networkSQLBuilder.append(")");
		SQL_CREATE_NETWORK_ENTRIES = networkSQLBuilder.toString();

        // ATTACK
		StringBuilder attackSQLBuilder = new StringBuilder("CREATE TABLE ").append(HostageDBContract.AttackEntry.TABLE_NAME).append("(");
		attackSQLBuilder.append(HostageDBContract.AttackEntry.COLUMN_NAME_ATTACK_ID).append(" INTEGER PRIMARY KEY,");
		attackSQLBuilder.append(HostageDBContract.AttackEntry.COLUMN_NAME_PROTOCOL).append(" TEXT,");
		attackSQLBuilder.append(HostageDBContract.AttackEntry.COLUMN_NAME_EXTERNAL_IP).append(" TEXT,");
		attackSQLBuilder.append(HostageDBContract.AttackEntry.COLUMN_NAME_LOCAL_IP).append(" BLOB,");
		attackSQLBuilder.append(HostageDBContract.AttackEntry.COLUMN_NAME_LOCAL_PORT).append(" INTEGER,");
		attackSQLBuilder.append(HostageDBContract.AttackEntry.COLUMN_NAME_REMOTE_IP).append(" BLOB,");
		attackSQLBuilder.append(HostageDBContract.AttackEntry.COLUMN_NAME_REMOTE_PORT).append(" INTEGER,");
		attackSQLBuilder.append(HostageDBContract.AttackEntry.COLUMN_NAME_INTERNAL_ATTACK).append(" INTEGER,");
		attackSQLBuilder.append(HostageDBContract.AttackEntry.COLUMN_NAME_BSSID).append(" TEXT,");
        attackSQLBuilder.append(HostageDBContract.AttackEntry.COLUMN_NAME_SYNC_ID).append(" INTEGER,");
        attackSQLBuilder.append(HostageDBContract.AttackEntry.COLUMN_NAME_DEVICE).append(" TEXT,");
		attackSQLBuilder.append(String.format("FOREIGN KEY(%s) REFERENCES %s(%s) ON DELETE CASCADE ON UPDATE CASCADE,", HostageDBContract.AttackEntry.COLUMN_NAME_BSSID, HostageDBContract.NetworkEntry.TABLE_NAME,
				HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID));
        attackSQLBuilder.append(String.format("FOREIGN KEY(%s) REFERENCES %s(%s) ON DELETE CASCADE ON UPDATE CASCADE", HostageDBContract.AttackEntry.COLUMN_NAME_DEVICE, HostageDBContract.SyncDeviceEntry.TABLE_NAME,
        ...
        // PACKET
		StringBuilder packetSQLBuilder = new StringBuilder("CREATE TABLE ").append(HostageDBContract.PacketEntry.TABLE_NAME).append("(");
		packetSQLBuilder.append(HostageDBContract.PacketEntry.COLUMN_NAME_ID).append(" INTEGER NOT NULL,");
		packetSQLBuilder.append(HostageDBContract.PacketEntry.COLUMN_NAME_ATTACK_ID).append(" INTEGER NOT NULL,");
		packetSQLBuilder.append(HostageDBContract.PacketEntry.COLUMN_NAME_TYPE).append(" TEXT,");
		packetSQLBuilder.append(HostageDBContract.PacketEntry.COLUMN_NAME_PACKET_TIMESTAMP).append(" INTEGER,");
		packetSQLBuilder.append(HostageDBContract.PacketEntry.COLUMN_NAME_PACKET).append(" TEXT,");
		packetSQLBuilder.append(String.format("PRIMARY KEY(%s,%s)", HostageDBContract.PacketEntry.COLUMN_NAME_ID, HostageDBContract.PacketEntry.COLUMN_NAME_ATTACK_ID));
		packetSQLBuilder.append(String.format("FOREIGN KEY(%s) REFERENCES %s(%s)", HostageDBContract.PacketEntry.COLUMN_NAME_ATTACK_ID, HostageDBContract.AttackEntry.TABLE_NAME,
        ...
        // SyncDeviceEntry
		StringBuilder syncDevicesSQLBuilder = new StringBuilder("CREATE TABLE ").append(HostageDBContract.SyncDeviceEntry.TABLE_NAME).append("(");
		syncDevicesSQLBuilder.append(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_DEVICE_ID).append(" TEXT PRIMARY KEY,");
		syncDevicesSQLBuilder.append(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_DEVICE_TIMESTAMP).append(" INTEGER,");
        syncDevicesSQLBuilder.append(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_HIGHEST_ATTACK_ID).append(" INTEGER");
        syncDevicesSQLBuilder.append(")");
		SQL_CREATE_SYNC_DEVICES_ENTRIES = syncDevicesSQLBuilder.toString();

        // SyncInfoEntry
		StringBuilder syncInfoSQLBuilder = new StringBuilder("CREATE TABLE ").append(HostageDBContract.SyncInfoEntry.TABLE_NAME).append("(");
		syncInfoSQLBuilder.append(HostageDBContract.SyncInfoEntry.COLUMN_NAME_DEVICE_ID).append(" TEXT,");
		syncInfoSQLBuilder.append(HostageDBContract.SyncInfoEntry.COLUMN_NAME_BSSID).append(" TEXT,");
		syncInfoSQLBuilder.append(HostageDBContract.SyncInfoEntry.COLUMN_NAME_NUMBER_ATTACKS).append(" INTEGER,");
		syncInfoSQLBuilder.append(HostageDBContract.SyncInfoEntry.COLUMN_NAME_NUMBER_PORTSCANS).append(" INTEGER,");
		syncInfoSQLBuilder.append(String.format("PRIMARY KEY(%s,%s)", HostageDBContract.SyncInfoEntry.COLUMN_NAME_DEVICE_ID, HostageDBContract.SyncInfoEntry.COLUMN_NAME_BSSID));
		syncInfoSQLBuilder.append(String.format("FOREIGN KEY(%s) REFERENCES %s(%s)", HostageDBContract.SyncInfoEntry.COLUMN_NAME_BSSID, HostageDBContract.NetworkEntry.TABLE_NAME,
				HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID));
		syncInfoSQLBuilder.append(")");
		SQL_CREATE_SYNC_INFO_ENTRIES = syncInfoSQLBuilder.toString();

        // ProfileEntry
		StringBuilder profilSQLBuilder = new StringBuilder("CREATE TABLE ").append(HostageDBContract.ProfileEntry.TABLE_NAME).append("(");
		profilSQLBuilder.append(HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_ID).append(" INTEGER PRIMARY KEY AUTOINCREMENT,");
		profilSQLBuilder.append(HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_NAME).append(" TEXT,");
		profilSQLBuilder.append(HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_DESCRIPTION ).append(" TEXT,");
		profilSQLBuilder.append(HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_ICON).append(" TEXT,");
		profilSQLBuilder.append(HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_ICON_NAME).append(" TEXT,");
		profilSQLBuilder.append(HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_EDITABLE).append(" INTEGER,");
		profilSQLBuilder.append(HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_ACTIVE).append(" INTEGER");
	...
	private static final String SQL_DELETE_PACKET_ENTRIES = "DROP TABLE IF EXISTS " + HostageDBContract.PacketEntry.TABLE_NAME;
	private static final String SQL_DELETE_ATTACK_ENTRIES = "DROP TABLE IF EXISTS " + HostageDBContract.AttackEntry.TABLE_NAME;
	private static final String SQL_DELETE_NETWORK_ENTRIES = "DROP TABLE IF EXISTS " + HostageDBContract.NetworkEntry.TABLE_NAME;
	private static final String SQL_DELETE_PROFILE_ENTRIES = "DROP TABLE IF EXISTS " + HostageDBContract.ProfileEntry.TABLE_NAME;
	private static final String SQL_DELETE_SYNC_DEVICES_ENTRIES = "DROP TABLE IF EXISTS " + HostageDBContract.SyncDeviceEntry.TABLE_NAME;
	private static final String SQL_DELETE_SYNC_INFO_ENTRIES = "DROP TABLE IF EXISTS " + HostageDBContract.SyncInfoEntry.TABLE_NAME;
    ...
    synchronized private void insertMessageRecordWithOnConflict(MessageRecord record, SQLiteDatabase db){
        ...
        recordValues.put(HostageDBContract.PacketEntry.COLUMN_NAME_ID, record.getId()); // Log Message Number
        recordValues.put(HostageDBContract.PacketEntry.COLUMN_NAME_ATTACK_ID, record.getAttack_id()); // Log Attack ID
        recordValues.put(HostageDBContract.PacketEntry.COLUMN_NAME_TYPE, record.getType().name()); // Log Type
        recordValues.put(HostageDBContract.PacketEntry.COLUMN_NAME_PACKET_TIMESTAMP, record.getTimestamp()); // Log Timestamp
        recordValues.put(HostageDBContract.PacketEntry.COLUMN_NAME_PACKET, record.getPacket()); // Log Packet

        // Inserting Rows
        db.insertWithOnConflict(HostageDBContract.PacketEntry.TABLE_NAME, null, recordValues, SQLiteDatabase.CONFLICT_REPLACE);
    }
    ...
    synchronized public void updateUntrackedAttacks(){
        SQLiteDatabase db = this.getWritableDatabase();
        String selectQuery = "SELECT * FROM " + HostageDBContract.AttackEntry.TABLE_NAME + " A WHERE " + HostageDBContract.AttackEntry.COLUMN_NAME_DEVICE + " IS NULL ORDER BY " + HostageDBContract.AttackEntry.COLUMN_NAME_ATTACK_ID + " DESC";
        Cursor cursor = db.rawQuery(selectQuery, null);
    ...
    synchronized private void insertAttackRecordWithOnConflict(AttackRecord record, SQLiteDatabase db){
        ...
        attackValues.put(HostageDBContract.AttackEntry.COLUMN_NAME_ATTACK_ID, record.getAttack_id()); // Log Attack ID
        attackValues.put(HostageDBContract.AttackEntry.COLUMN_NAME_PROTOCOL, record.getProtocol());
        attackValues.put(HostageDBContract.AttackEntry.COLUMN_NAME_EXTERNAL_IP, record.getExternalIP());
        attackValues.put(HostageDBContract.AttackEntry.COLUMN_NAME_LOCAL_IP, record.getLocalIP()); // Log Local IP
        attackValues.put(HostageDBContract.AttackEntry.COLUMN_NAME_LOCAL_PORT, record.getLocalPort());
        attackValues.put(HostageDBContract.AttackEntry.COLUMN_NAME_REMOTE_IP, record.getRemoteIP()); // Log Remote IP
        attackValues.put(HostageDBContract.AttackEntry.COLUMN_NAME_REMOTE_PORT, record.getRemotePort()); // Log Remote Port
        attackValues.put(HostageDBContract.AttackEntry.COLUMN_NAME_INTERNAL_ATTACK, record.getWasInternalAttack());
        attackValues.put(HostageDBContract.AttackEntry.COLUMN_NAME_BSSID, record.getBssid());
        attackValues.put(HostageDBContract.AttackEntry.COLUMN_NAME_DEVICE, record.getDevice());
        attackValues.put(HostageDBContract.AttackEntry.COLUMN_NAME_SYNC_ID, record.getSync_id());

        // Inserting Rows
        db.insertWithOnConflict(HostageDBContract.AttackEntry.TABLE_NAME, null, attackValues, SQLiteDatabase.CONFLICT_REPLACE);
    }
    ...
    synchronized public void updateSyncDevicesMaxID(SQLiteDatabase db){
        ...
        String selectQuery = "SELECT "+ HostageDBContract.AttackEntry.COLUMN_NAME_DEVICE+ ","
                + HostageDBContract.AttackEntry.COLUMN_NAME_SYNC_ID+" FROM " + HostageDBContract.AttackEntry.TABLE_NAME + " A "
                + " WHERE " + HostageDBContract.AttackEntry.COLUMN_NAME_SYNC_ID + " NOT NULL "  + " GROUP BY "
                + HostageDBContract.AttackEntry.COLUMN_NAME_DEVICE + " HAVING " + HostageDBContract.AttackEntry.COLUMN_NAME_SYNC_ID
                + " = MAX( " + HostageDBContract.AttackEntry.COLUMN_NAME_SYNC_ID + " )";
    ...
    synchronized public void updateSyncAttackCounter(AttackRecord record){
		...
		syncDeviceValues.put(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_DEVICE_ID, currentDevice.getDeviceID());
		syncDeviceValues.put(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_DEVICE_TIMESTAMP, System.currentTimeMillis());
		syncDeviceValues.put(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_HIGHEST_ATTACK_ID, record.getAttack_id());

		db.insertWithOnConflict(HostageDBContract.SyncDeviceEntry.TABLE_NAME, null, syncDeviceValues, SQLiteDatabase.CONFLICT_REPLACE);
		db.close(); // Closing database connection
	}
	...
	public synchronized boolean bssidSeen(String BSSID) {
		String countQuery = "SELECT  * FROM " + HostageDBContract.NetworkEntry.TABLE_NAME + " WHERE " + HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID + " = ?";
		SQLiteDatabase db = this.getReadableDatabase();
	...
	public synchronized boolean bssidSeen(String protocol, String BSSID) {
		...
		String countQuery = "SELECT  * FROM " + HostageDBContract.AttackEntry.TABLE_NAME + " NATURAL JOIN " + HostageDBContract.NetworkEntry.TABLE_NAME + " WHERE "
				+ HostageDBContract.AttackEntry.COLUMN_NAME_PROTOCOL + " = ? AND " + HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID + " = ?";
		SQLiteDatabase db = this.getReadableDatabase();
	...
	public synchronized int getNumAttacksSeenByBSSID(String BSSID) {
		String countQuery = "SELECT  COUNT(*) FROM " + HostageDBContract.AttackEntry.TABLE_NAME + " WHERE "
				+ HostageDBContract.AttackEntry.TABLE_NAME + "." + HostageDBContract.AttackEntry.COLUMN_NAME_BSSID + " = " + "'" + BSSID + "'";
		SQLiteDatabase db = this.getReadableDatabase();
    ...
    synchronized public int getNumAttacksSeenByBSSID(String protocol, String BSSID) {
		String countQuery = "SELECT  COUNT(*) FROM " + HostageDBContract.AttackEntry.TABLE_NAME
						+  " WHERE " + HostageDBContract.AttackEntry.TABLE_NAME + "." + HostageDBContract.AttackEntry.COLUMN_NAME_PROTOCOL + " = " + "'" + protocol + "'"
						+  " AND " + HostageDBContract.AttackEntry.TABLE_NAME + "." + HostageDBContract.AttackEntry.COLUMN_NAME_BSSID + " = " + "'" + BSSID + "'";
		SQLiteDatabase db = this.getReadableDatabase();
		Cursor cursor = db.rawQuery(countQuery, null);
		cursor.moveToFirst();
		int result = cursor.getInt(0);
	...
	public synchronized ArrayList<String> getAllBSSIDS() {
		String selectQuery = "SELECT "+ HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID+" FROM " + HostageDBContract.NetworkEntry.TABLE_NAME;
		SQLiteDatabase db = this.getReadableDatabase();
		Cursor cursor = db.rawQuery(selectQuery, null);
    ...
    public synchronized ArrayList<NetworkRecord> getMissingNetworkRecords(ArrayList<String> otherBSSIDs) {
        String prefix = " WHERE " + "N."+ HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID + " NOT IN ";
        String selectQuery = "SELECT * FROM " + HostageDBContract.NetworkEntry.TABLE_NAME + " N " + this.arrayToSQLString(otherBSSIDs, prefix);
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);
	...
	public synchronized int getAttackCount() {
		SQLiteDatabase db = this.getReadableDatabase();
		String countQuery = "SELECT  * FROM " + HostageDBContract.AttackEntry.TABLE_NAME +
				           " WHERE " + HostageDBContract.AttackEntry.COLUMN_NAME_PROTOCOL + " <> ?";
	...
	public synchronized int getAttackCount(int attack_id, String bssid) {
		...
		String countQuery = "SELECT * FROM " + HostageDBContract.AttackEntry.TABLE_NAME +
				           " WHERE "+ HostageDBContract.AttackEntry.COLUMN_NAME_PROTOCOL + " <> ? " +
				           	"AND " + HostageDBContract.AttackEntry.COLUMN_NAME_ATTACK_ID + " > ? " +
				           	"AND " + HostageDBContract.AttackEntry.COLUMN_NAME_BSSID + " = ?";
	...
	public synchronized int getRecordCount() {
		String countQuery = "SELECT  * FROM " + HostageDBContract.PacketEntry.TABLE_NAME;
		SQLiteDatabase db = this.getReadableDatabase();
		Cursor cursor = db.rawQuery(countQuery, null);
		int result = cursor.getCount();
		cursor.close();
	...
	public synchronized ArrayList<AttackRecord> getRecordOfEachAttack() {
		...
		String selectQuery = "SELECT  * FROM " + HostageDBContract.AttackEntry.TABLE_NAME;
		SQLiteDatabase db = this.getReadableDatabase();
		Cursor cursor = db.rawQuery(selectQuery, null);
	...
	public synchronized ArrayList<AttackRecord> getRecordOfEachAttack(long attack_id) {
		ArrayList<AttackRecord> recordList = new ArrayList<AttackRecord>();
		String selectQuery = "SELECT  * FROM " + HostageDBContract.AttackEntry.TABLE_NAME + " WHERE " + HostageDBContract.AttackEntry.COLUMN_NAME_ATTACK_ID + " > " + attack_id;
		SQLiteDatabase db = this.getReadableDatabase();
		Cursor cursor = db.rawQuery(selectQuery, null);
	...
	public synchronized long getHighestAttackId() {
		String selectQuery = "SELECT MAX(" + HostageDBContract.AttackEntry.COLUMN_NAME_ATTACK_ID + ") FROM " + HostageDBContract.AttackEntry.TABLE_NAME;
		SQLiteDatabase db = this.getReadableDatabase();
		Cursor cursor = db.rawQuery(selectQuery, null);
		int result;
	...
	public synchronized long getSmallestAttackId() {
		String selectQuery = "SELECT MIN(" + HostageDBContract.AttackEntry.COLUMN_NAME_ATTACK_ID + ") FROM " + HostageDBContract.AttackEntry.TABLE_NAME;
		SQLiteDatabase db = this.getReadableDatabase();
		Cursor cursor = db.rawQuery(selectQuery, null);
		int result;
	...
	public synchronized String getSSID(String bssid) {
		String selectQuery = "SELECT " + HostageDBContract.NetworkEntry.COLUMN_NAME_SSID + " FROM " + HostageDBContract.NetworkEntry.TABLE_NAME + " WHERE " + HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID
				+ " = " + "'" + bssid + "'";
		SQLiteDatabase db = this.getReadableDatabase();
		Cursor cursor = db.rawQuery(selectQuery, null);
		String ssid = null;
	...
	public synchronized ArrayList<NetworkRecord> getNetworkInformation() {
		String selectQuery = "SELECT  * FROM " + HostageDBContract.NetworkEntry.TABLE_NAME;
		SQLiteDatabase db = this.getReadableDatabase();
		Cursor cursor = db.rawQuery(selectQuery, null);
	...
	public synchronized void updateNetworkInformation(ArrayList<NetworkRecord> networkInformation) {
        ...
        try {
            for (NetworkRecord record : networkInformation) {
                ...
                String bssidQuery = "SELECT  * FROM " +  HostageDBContract.NetworkEntry.TABLE_NAME + " WHERE " +  HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID + " = ?";
                ...
                if (!cursor.moveToFirst() || cursor.getLong(5) < record.getTimestampLocation()){
                    ...
                    bssidValues.put(HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID, bssid);
                    bssidValues.put(HostageDBContract.NetworkEntry.COLUMN_NAME_SSID, record.getSsid());
                    bssidValues.put(HostageDBContract.NetworkEntry.COLUMN_NAME_LATITUDE, record.getLatitude());
                    bssidValues.put(HostageDBContract.NetworkEntry.COLUMN_NAME_LONGITUDE, record.getLongitude());
                    bssidValues.put(HostageDBContract.NetworkEntry.COLUMN_NAME_ACCURACY, record.getAccuracy());
                    bssidValues.put(HostageDBContract.NetworkEntry.COLUMN_NAME_GEO_TIMESTAMP, record.getTimestampLocation());
                    db.insertWithOnConflict(HostageDBContract.NetworkEntry.TABLE_NAME, null, bssidValues, SQLiteDatabase.CONFLICT_REPLACE);
                }
                cursor.close();
            }
            db.setTransactionSuccessful();
	...
	public synchronized void updateTimestampOfSyncDevice(String deviceID, long timestamp){
		...
		deviceValues.put(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_DEVICE_ID, deviceID);
		deviceValues.put(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_DEVICE_TIMESTAMP, timestamp);
		db.insertWithOnConflict(HostageDBContract.SyncDeviceEntry.TABLE_NAME, null, deviceValues, SQLiteDatabase.CONFLICT_REPLACE);
		db.close();
	}
	...
	public synchronized void updateSyncDevices(HashMap<String, Long> devices){
        ...
        try {
            for(String key : devices.keySet()){
                ContentValues deviceValues = new ContentValues();
                deviceValues.put(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_DEVICE_ID, key);
                deviceValues.put(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_DEVICE_TIMESTAMP, devices.get(key));
                db.insertWithOnConflict(HostageDBContract.SyncDeviceEntry.TABLE_NAME, null, deviceValues, SQLiteDatabase.CONFLICT_REPLACE);
            }
            db.setTransactionSuccessful();
        } finally {
    ...
    public synchronized void updateSyncDevices(ArrayList<SyncDevice> devices, SQLiteDatabase db){
        ...
        try {
            for(SyncDevice device : devices){
                ContentValues deviceValues = new ContentValues();
                deviceValues.put(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_DEVICE_ID, device.getDeviceID());
                deviceValues.put(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_DEVICE_TIMESTAMP, device.getLast_sync_timestamp());
                deviceValues.put(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_HIGHEST_ATTACK_ID, device.getHighest_attack_id());
                db.insertWithOnConflict(HostageDBContract.SyncDeviceEntry.TABLE_NAME, null, deviceValues, SQLiteDatabase.CONFLICT_REPLACE);
            }
            db.setTransactionSuccessful();
        } finally {
	...
	public synchronized HashMap<String, Long> getSyncDeviceHashMap(){
		...
		String query = "SELECT  * FROM " + HostageDBContract.SyncDeviceEntry.TABLE_NAME;
	...
	public synchronized ArrayList<SyncInfoRecord> getSyncInfo(){
		...
		String query = "SELECT  * FROM " + HostageDBContract.SyncInfoEntry.TABLE_NAME;
		Cursor cursor = db.rawQuery(query, null);
	...
	public synchronized void updateSyncInfo(ArrayList<SyncInfoRecord> syncInfos){
        ...
        try {
            for(SyncInfoRecord syncInfo : syncInfos){
                ...
                syncValues.put(HostageDBContract.SyncInfoEntry.COLUMN_NAME_BSSID, syncInfo.getBSSID());
                syncValues.put(HostageDBContract.SyncInfoEntry.COLUMN_NAME_DEVICE_ID, syncInfo.getDeviceID());
                syncValues.put(HostageDBContract.SyncInfoEntry.COLUMN_NAME_NUMBER_ATTACKS, syncInfo.getNumber_of_attacks());
                syncValues.put(HostageDBContract.SyncInfoEntry.COLUMN_NAME_NUMBER_PORTSCANS, syncInfo.getNumber_of_portscans());
                db.insertWithOnConflict(HostageDBContract.SyncInfoEntry.TABLE_NAME, null, syncValues, SQLiteDatabase.CONFLICT_REPLACE);
            }
            db.setTransactionSuccessful();
        } finally {
            db.endTransaction();
	...
	/**
	 * Deletes a device with given id from the device {@link HostageDBContract.SyncDeviceEntry} and also all data captured by this device in  {@link HostageDBContract.SyncInfoEntry}
	 */
	public synchronized void clearSyncInfos(){
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(HostageDBContract.SyncDeviceEntry.TABLE_NAME, null, null);
		db.delete(HostageDBContract.SyncInfoEntry.TABLE_NAME, null, null);
		db.close();
	}
	
	
	/**
	 * Deletes all records from {@link HostageDBContract.PacketEntry}s and {@link AttackRecord}.
	 */
	public synchronized void clearData() {
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(HostageDBContract.PacketEntry.TABLE_NAME, null, null);
		db.delete(HostageDBContract.AttackEntry.TABLE_NAME, null, null);
		db.close();
	}

	/**
	 * Deletes all records from {@link HostageDBContract.PacketEntry}s with a specific BSSID.
	 * 
	 * @param bssid
	 *            The BSSID to match against.
	 */
	public synchronized void deleteByBSSID(String bssid) {
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(HostageDBContract.NetworkEntry.TABLE_NAME, HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID + " = ?", new String[] { bssid });
		db.delete(HostageDBContract.AttackEntry.TABLE_NAME, HostageDBContract.AttackEntry.COLUMN_NAME_BSSID + " = ?", new String[]{bssid});
		db.close();
	}
	
	/**
	 * Deletes all records from {@link HostageDBContract.PacketEntry}s with a time stamp smaller
	 * then the given
	 * 
	 * @param date
	...
	public synchronized void deleteByDate(long date) {
		SQLiteDatabase db = this.getWritableDatabase();
		String deleteQuery = "DELETE  FROM " + HostageDBContract.PacketEntry.TABLE_NAME + " WHERE " + HostageDBContract.PacketEntry.COLUMN_NAME_PACKET_TIMESTAMP + " < " + date;
	...
	public synchronized void deleteByAttackID(long attackID) {
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(HostageDBContract.AttackEntry.TABLE_NAME, HostageDBContract.AttackEntry.COLUMN_NAME_ATTACK_ID + " = ?", new String[]{String.valueOf(attackID)});
		db.delete(HostageDBContract.PacketEntry.TABLE_NAME, HostageDBContract.PacketEntry.COLUMN_NAME_ATTACK_ID + " = ?", new String[]{String.valueOf(attackID)});
		db.close();
	}
    ...
    public synchronized void deleteAttacksByFilter(LogFilter filter){
        String selectQuery = this.selectionQueryFromFilter(filter, "" + HostageDBContract.AttackEntry.COLUMN_NAME_ATTACK_ID);
        String deletePacketQuery = "DELETE  FROM " + HostageDBContract.PacketEntry.TABLE_NAME + " WHERE "+ HostageDBContract.PacketEntry.TABLE_NAME + "."+ HostageDBContract.PacketEntry.COLUMN_NAME_ATTACK_ID+" in ( ";
        deletePacketQuery = deletePacketQuery + selectQuery + " )";
        String deleteAttacksQuery = "DELETE  FROM " + HostageDBContract.AttackEntry.TABLE_NAME + " WHERE "+ HostageDBContract.AttackEntry.TABLE_NAME + "."+ HostageDBContract.AttackEntry.COLUMN_NAME_ATTACK_ID+" in ( ";
    ...
    public ArrayList<MessageRecord> getMessageRecords(AttackRecord attackRecord , SQLiteDatabase db){
        ...
        String selectQuery = "SELECT  * FROM " + HostageDBContract.PacketEntry.TABLE_NAME + " WHERE " + HostageDBContract.PacketEntry.COLUMN_NAME_ATTACK_ID + " = " + attackRecord.getAttack_id();
	...
	private synchronized Record createRecord(Cursor cursor) {
        ...
        record.setDevice(cursor.getString(cursor.getColumnIndex(HostageDBContract.AttackEntry.COLUMN_NAME_DEVICE)));
		record.setSync_ID(cursor.getLong(cursor.getColumnIndex(HostageDBContract.AttackEntry.COLUMN_NAME_SYNC_ID)));
    ...
    public String selectionQueryFromFilter(LogFilter filter, String selectionString)
    {
        ...
        String selectQuery = "SELECT " + selectionString + " FROM " + HostageDBContract.PacketEntry.TABLE_NAME + " NATURAL JOIN " + HostageDBContract.AttackEntry.TABLE_NAME + " JOIN " + HostageDBContract.NetworkEntry.TABLE_NAME + " USING " + "(" + HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID
                + ")";
        if (filter == null) return selectQuery;

        // TIMESTAMPS
        selectQuery = selectQuery + " WHERE " + HostageDBContract.PacketEntry.TABLE_NAME + "." + HostageDBContract.PacketEntry.COLUMN_NAME_PACKET_TIMESTAMP;
        selectQuery = selectQuery + " < " + filter.getBelowTimestamp();
        selectQuery = selectQuery + " AND " + HostageDBContract.PacketEntry.TABLE_NAME + "." + HostageDBContract.PacketEntry.COLUMN_NAME_PACKET_TIMESTAMP;
        ...
        if (filter.getBSSIDs() != null && filter.getBSSIDs().size() > 0) {
            ...
            selectQuery = selectQuery + filter.getBSSIDQueryStatement(HostageDBContract.NetworkEntry.TABLE_NAME, HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID);
        }
        if (filter.getESSIDs() != null && filter.getESSIDs().size() > 0) {
            selectQuery = selectQuery + " AND ";
            selectQuery = selectQuery + filter.getESSIDQueryStatement(HostageDBContract.NetworkEntry.TABLE_NAME, HostageDBContract.NetworkEntry.COLUMN_NAME_SSID);
        }
        if (filter.getProtocols() != null && filter.getProtocols().size() > 0) {
            selectQuery = selectQuery + " AND ";
            selectQuery = selectQuery + filter.getProtocolsQueryStatement(HostageDBContract.AttackEntry.TABLE_NAME, HostageDBContract.AttackEntry.COLUMN_NAME_PROTOCOL);
        }

        selectQuery = selectQuery + " GROUP BY " + HostageDBContract.PacketEntry.TABLE_NAME + "." + HostageDBContract.PacketEntry.COLUMN_NAME_ATTACK_ID;
	...
	public synchronized ArrayList<Record> getConversationForAttackID(long attack_id) {
		ArrayList<Record> recordList = new ArrayList<Record>();
		String selectQuery = "SELECT  * FROM " + HostageDBContract.PacketEntry.TABLE_NAME + " NATURAL JOIN " + HostageDBContract.AttackEntry.TABLE_NAME + " JOIN " + HostageDBContract.NetworkEntry.TABLE_NAME + " USING " + "(" + HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID
				+ ")" + " WHERE " + HostageDBContract.PacketEntry.TABLE_NAME + "." + HostageDBContract.PacketEntry.COLUMN_NAME_ATTACK_ID + " = " + attack_id;
	...
	public synchronized Record getRecordOfAttackId(long attack_id) {
		String selectQuery = "SELECT  * FROM " + HostageDBContract.PacketEntry.TABLE_NAME + " NATURAL JOIN " + HostageDBContract.AttackEntry.TABLE_NAME + " JOIN " + HostageDBContract.NetworkEntry.TABLE_NAME + " USING " + "(" + HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID
				+ ")" + " WHERE " + HostageDBContract.PacketEntry.TABLE_NAME + "." + HostageDBContract.PacketEntry.COLUMN_NAME_ATTACK_ID + " = " + attack_id + " GROUP BY " + HostageDBContract.PacketEntry.TABLE_NAME + "." + HostageDBContract.PacketEntry.COLUMN_NAME_ID;
		SQLiteDatabase db = this.getReadableDatabase();
		Cursor cursor = db.rawQuery(selectQuery, null);
		Record record = null;
	...
	public synchronized Record getRecord(int id) {
		String selectQuery = "SELECT  * FROM " + HostageDBContract.PacketEntry.TABLE_NAME + " NATURAL JOIN " + HostageDBContract.AttackEntry.TABLE_NAME + " JOIN " + HostageDBContract.NetworkEntry.TABLE_NAME + " USING " + "(" + HostageDBContract.PacketEntry.COLUMN_NAME_ATTACK_ID
				+ ")" + " WHERE " + HostageDBContract.PacketEntry.TABLE_NAME + "." + HostageDBContract.PacketEntry.COLUMN_NAME_ID + " = " + id;
		SQLiteDatabase db = this.getReadableDatabase();
	...
	public synchronized ArrayList<String> getUniqueBSSIDRecords() {
		return this.getUniqueDataEntryForKeyType(HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID, HostageDBContract.NetworkEntry.TABLE_NAME);
	}
	...
	public synchronized ArrayList<String> getUniqueESSIDRecords() {
		return this.getUniqueDataEntryForKeyType(HostageDBContract.NetworkEntry.COLUMN_NAME_SSID, HostageDBContract.NetworkEntry.TABLE_NAME);
	}

	public synchronized ArrayList<String> getUniqueESSIDRecordsForProtocol(String protocol) {
		return this.getUniqueIDForProtocol(HostageDBContract.NetworkEntry.COLUMN_NAME_SSID, protocol);
	}

	public synchronized ArrayList<String> getUniqueBSSIDRecordsForProtocol(String protocol) {
		return this.getUniqueIDForProtocol(HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID, protocol);
	}

	private synchronized ArrayList<String> getUniqueIDForProtocol(String id, String protocol) {
		ArrayList<String> recordList = new ArrayList<String>();
		String selectQuery = "SELECT DISTINCT " + id + " FROM " + HostageDBContract.AttackEntry.TABLE_NAME + " JOIN " + HostageDBContract.NetworkEntry.TABLE_NAME + " USING " + "(" + HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID + ") " + " WHERE "
				+ HostageDBContract.AttackEntry.TABLE_NAME + "." + HostageDBContract.AttackEntry.COLUMN_NAME_PROTOCOL + " = " + "'" + protocol + "'" + " ORDER BY " + "'"+id+"'"; // " NATURAL JOIN "
																												// +
																												// TABLE_ATTACK_INFO
																												// +
																												// " NATURAL JOIN "
	...
	public synchronized List<Profile> getAllProfiles() {
		...
		// Select All Query
		String selectQuery = "SELECT  * FROM " + HostageDBContract.ProfileEntry.TABLE_NAME;
	...
	public synchronized long persistProfile(Profile profile) {
		...
		if (profile.mId != -1) {
			values.put(HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_ID, profile.mId);
		}

		values.put(HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_NAME, profile.mLabel);
		values.put(HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_DESCRIPTION, profile.mText);
		values.put(HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_ICON, profile.mIconPath);
		values.put(HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_ICON_NAME, profile.mIconName);
		values.put(HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_ACTIVE, profile.mActivated);
		values.put(HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_EDITABLE, profile.mEditable);

		return db.replace(HostageDBContract.ProfileEntry.TABLE_NAME, null, values);
	}
	...
	public synchronized Profile getProfile(int id) {
		String selectQuery = "SELECT  * FROM " + HostageDBContract.ProfileEntry.TABLE_NAME + " WHERE " + HostageDBContract.ProfileEntry.TABLE_NAME + "." + HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_ID + " = " + id;
		SQLiteDatabase db = this.getReadableDatabase();
	...
	public synchronized void deleteProfile(int id) {
		...
		db.delete(HostageDBContract.ProfileEntry.TABLE_NAME, HostageDBContract.ProfileEntry.COLUMN_NAME_PROFILE_ID + "=?", new String[] { String.valueOf(id) });
        db.close();
	}
	...
	public synchronized ArrayList<Record> getAllReceivedRecordsOfEachAttack() {
		ArrayList<Record> recordList = new ArrayList<Record>();
		String selectQuery = "SELECT  * FROM " + HostageDBContract.PacketEntry.TABLE_NAME + " NATURAL JOIN " + HostageDBContract.AttackEntry.TABLE_NAME + " JOIN " + HostageDBContract.NetworkEntry.TABLE_NAME + " USING " + "(" + HostageDBContract.NetworkEntry.COLUMN_NAME_BSSID
				+ ")" + " WHERE " + HostageDBContract.PacketEntry.COLUMN_NAME_TYPE + "='RECEIVE'" + " ORDER BY " + HostageDBContract.PacketEntry.TABLE_NAME + "." + HostageDBContract.PacketEntry.COLUMN_NAME_PACKET_TIMESTAMP;
		SQLiteDatabase db = this.getReadableDatabase();
		Cursor cursor = db.rawQuery(selectQuery, null);
    ...
    public synchronized ArrayList<PlotComparisonItem> attacksPerESSID(LogFilter filter) {
        ...
        String filterQuery = this.selectionQueryFromFilter(filter, HostageDBContract.AttackEntry.COLUMN_NAME_ATTACK_ID);

        filterQuery = filterQuery.split("GROUP BY")[0];

        String attackPerESSID_Query = "SELECT " + HostageDBContract.NetworkEntry.COLUMN_NAME_SSID + " , " + "COUNT( " + " * " + "  ) " + " "
                                    + " FROM "  +  HostageDBContract.AttackEntry.TABLE_NAME + " NATURAL JOIN " + HostageDBContract.NetworkEntry.TABLE_NAME //AttackEntry.TABLE_NAME + " a " + " , " + NetworkEntry.TABLE_NAME
                                    + " WHERE " + HostageDBContract.AttackEntry.COLUMN_NAME_ATTACK_ID + " IN " + " ( " + filterQuery + " ) "
                                    + " GROUP BY " + HostageDBContract.NetworkEntry.TABLE_NAME+"."+ HostageDBContract.NetworkEntry.COLUMN_NAME_SSID;
    ...
    /**
     * Creates a {@link SyncDevice} from a Cursor. If the cursor does not show to a
     * valid data structure a runtime exception is thrown.
     *
     * @param cursor the cursor
     * @return Returns the created {@link SyncDevice} .
     */
     ...
     * @param oldDevices array of {@link SyncDevice}s
    ...
    public synchronized  ArrayList<SyncDevice> getUpdatedDevicesFor(HashMap<String, Long> oldDeviceMap, boolean includeMissing){
        ...
        ArrayList<SyncDevice> recordList = new ArrayList<SyncDevice>();
        String selectQuery = "SELECT * FROM " + HostageDBContract.SyncDeviceEntry.TABLE_NAME;
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);
    ...
    public synchronized  ArrayList<String> getAllDevicesIds(){
        ...
        String selectQuery = "SELECT "+ HostageDBContract.SyncDeviceEntry.COLUMN_NAME_DEVICE_ID+" FROM " + HostageDBContract.SyncDeviceEntry.TABLE_NAME;
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);
    ...
    public synchronized  ArrayList<String> getMissingDeviceIds(ArrayList<String> devices){
        ArrayList<String> ids = new ArrayList<String>();
        String prefix = " D WHERE " + HostageDBContract.SyncDeviceEntry.COLUMN_NAME_DEVICE_ID + " NOT IN ";
        String selectQuery = "SELECT "+ HostageDBContract.SyncDeviceEntry.COLUMN_NAME_DEVICE_ID +" FROM " + HostageDBContract.SyncDeviceEntry.TABLE_NAME + this.arrayToSQLString(devices,prefix);
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);
    ...
    public synchronized  ArrayList<SyncRecord> getUnsyncedAttacksFor(HashMap<String,Long> deviceMap, boolean includeMissingDevices){
        ...
        for (SyncDevice sDevice : updatedDevices){
            ...
            String selectQuery = "SELECT * FROM " + HostageDBContract.AttackEntry.TABLE_NAME + " A "
                    + " WHERE "
                    +" ( "
                    + " A." + HostageDBContract.AttackEntry.COLUMN_NAME_DEVICE + " = " + "'" + deviceID + "'"
                    + " AND " + " A." + HostageDBContract.AttackEntry.COLUMN_NAME_SYNC_ID + " > " + checkId
                    + " ) "
                    //+ " GROUP BY " + AttackEntry.TABLE_NAME + "." + AttackEntry.COLUMN_NAME_DEVICE
                    + " ORDER BY " + " A" + "." + HostageDBContract.AttackEntry.COLUMN_NAME_SYNC_ID + " DESC ";
            Cursor cursor = db.rawQuery(selectQuery, null);
    ...
    public synchronized ArrayList<PlotComparisonItem> attacksPerBSSID(LogFilter filter) {
        ...
        String attackPerBSSID_Query = "SELECT " + HostageDBContract.AttackEntry.COLUMN_NAME_BSSID + " , " + "COUNT( " + "*" + "  ) " + " "
                + " FROM " + HostageDBContract.AttackEntry.TABLE_NAME + " a "
                + " WHERE " + " a." + HostageDBContract.AttackEntry.COLUMN_NAME_ATTACK_ID + " IN " + " ( " + filterQuery + " ) "
                + " GROUP BY " + HostageDBContract.AttackEntry.COLUMN_NAME_BSSID;
     ...
     * @param devices list of {@link SyncDevice}s
     */
     ...
     * @param device {@link SyncDevice}
     * @param db  {@link android.database.sqlite.SQLiteDatabase}
     */
    private void insertSyncDevice(SyncDevice device, SQLiteDatabase db){
        ContentValues recordValues = new ContentValues();
        recordValues.put(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_DEVICE_ID, device.getDeviceID());
        recordValues.put(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_DEVICE_TIMESTAMP, device.getLast_sync_timestamp());
        recordValues.put(HostageDBContract.SyncDeviceEntry.COLUMN_NAME_HIGHEST_ATTACK_ID, device.getHighest_attack_id());

        // Inserting Rows
        db.insertWithOnConflict(HostageDBContract.SyncDeviceEntry.TABLE_NAME, null, recordValues, SQLiteDatabase.CONFLICT_REPLACE);
    }
