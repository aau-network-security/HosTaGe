...
public class G extends Application implements Application.ActivityLifecycleCallbacks{
   ...
   /* public static boolean showQuickButton() {
    ...
    public static boolean ipv6Fwd(boolean val) {
        gPrefs.edit().putBoolean(IP6_FWD, val).apply();
        return val;
    }
    ...
    public static boolean ipv6Input(boolean val) {
        gPrefs.edit().putBoolean(IP6_INPUT, val).apply();
        return val;
    }
    ...
    public static boolean ipv6Output(boolean val) {
        gPrefs.edit().putBoolean(IP6_OUTPUT, val).apply();
        return val;
    }
    ...
    public static boolean isEnc(boolean val) {
        gPrefs.edit().putBoolean(PWD_ENCRYPT, val).apply();
        return val;
    }
    ...
    public static String initPath(String val) {
        gPrefs.edit().putString(INITPATH, val).apply();
        return val;
    }
    ...
    public static String getSelectedTheme(String val) {
        gPrefs.edit().putString(THEME, val).apply();
        return val;
    }
    ...
    public static String profile_pwd(String val) {
        gPrefs.edit().putString(PROFILE_PWD, val).apply();
        return val;
    }

    public static int getNotificationPriority() {
        return Integer.parseInt(Objects.requireNonNull(gPrefs.getString(NOTIFICATION_PRIORITY, "0")));
    }
    ...
    public static Boolean isFingerprintEnabled(Boolean val) {
        gPrefs.edit().putBoolean(FINGERPRINT_ENABLED, val).apply();
        return val;
    }
    ...
    public static boolean isProfileMigrated(boolean val) {
        gPrefs.edit().putBoolean(PROFILES_MIGRATED, val).apply();
        return val;
    }
    ...
    public static boolean hasRoot(boolean val) {
        gPrefs.edit().putBoolean(HAS_ROOT, val).apply();
        return val;
    }
    ...
    public static boolean showLogToasts(boolean val) {
        gPrefs.edit().putBoolean(SHOW_LOG_TOAST, val).apply();
        return val;
    }
    ...
    public static boolean enableIPv6(boolean val) {
        gPrefs.edit().putBoolean(ENABLE_IPV6, val).apply();
        return val;
    }
    ...
    public static boolean enableLogService(boolean val) {
        gPrefs.edit().putBoolean(ENABLE_LOG_SERVICE, val).apply();
        return val;
    }

    public static int logPingTimeout() {
        return Integer.parseInt(Objects.requireNonNull(gPrefs.getString(LOG_PING_TIMEOUT, "10")));
    }
    ...
    public static boolean enableAdmin(boolean val) {
        gPrefs.edit().putBoolean(ENABLE_ADMIN, val).apply();
        return val;
    }
    ...
    public static boolean showHost(boolean val) {
        gPrefs.edit().putBoolean(SHOW_HOST, val).apply();
        return val;
    }
    ...
    public static boolean enableDeviceCheck(boolean val) {
        gPrefs.edit().putBoolean(ENABLE_DEVICE_CHECK, val).apply();
        return val;
    }
    ...
    public static boolean enableMultiProfile(boolean val) {
        gPrefs.edit().putBoolean(ENABLE_MULTI_PROFILE, val).apply();
        return val;
    }
    ...
    public static boolean showUid(boolean val) {
        gPrefs.edit().putBoolean(SHOW_UID, val).apply();
        return val;
    }
    ...
    public static boolean showFilter(boolean val) {
        gPrefs.edit().putBoolean(SHOW_FILTER, val).apply();
        return val;
    }
    ...
    public static boolean kingDetected(boolean val) {
        gPrefs.edit().putBoolean(ISKINGDETECT, val).apply();
        return val;
    }
    ...
    public static String ip_path(String val) {
        gPrefs.edit().putString(IPTABLES_PATH, val).apply();
        return val;
    }
    ...
    public static String bb_path(String val) {
        gPrefs.edit().putString(BUSYBOX_PATH, val).apply();
        return val;
    }
    ...
    public static String locale(String val) {
        gPrefs.edit().putString(LANGUAGE, val).apply();
        return val;
    }
    ...
    public static String logDmsg(String val) {
        gPrefs.edit().putString(LOG_DMESG, val).apply();
        return val;
    }
    ...
    public static void sortBy(String sort) {
        gPrefs.edit().putString(SORT_BY, sort).apply();
    }
            ...
            if (clearSharedPreferences(ctx, profileName)) {
                ...
                if (!previousProfiles.isEmpty()) {
                    ...
                    if (items.remove(profileName)) {
                        gPrefs.edit().putString(ADDITIONAL_PROFILES, TextUtils.join(",", items)).apply();
                        return true;
                    }
                } else {
                    return false;
